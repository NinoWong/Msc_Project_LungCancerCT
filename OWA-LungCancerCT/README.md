...
This repository contains the LungCancerCT OpenMRS Open Web App.
...
This will create a file called `lungcancerct.zip` file in the `dist` directory,
...
This will build and deploy the app to the `C:/Users/Nino/openmrs-standalone-2.4/appdata/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "C:/Users/Nino/openmrs-standalone-2.4/appdata/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "C:/Users/Nino/openmrs-standalone-2.4/appdata/owa",
  "APP_ENTRY_POINT": "http://localhost:8081/openmrs-standalone/owa/lungcancerct/index.html"
}
```
