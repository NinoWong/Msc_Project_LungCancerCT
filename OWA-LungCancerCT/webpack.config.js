 ...
 */
// generated on 2023-07-08 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'lungcancerct';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/lungcancerct`,
	  css: `${__dirname}/app/css/lungcancerct.css`,
	  vendor : [
